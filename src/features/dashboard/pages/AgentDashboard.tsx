    ...
    <div className="dash">
      <header className="dash-topbar">
        ...
        <div className="dash-topbar-right">
          <span className="dash-role-badge" style={{ background: '#ECFDF5', color: '#065F46' }}>Support Agent</span>
          <span style={{ fontSize: '0.8rem', color: 'var(--slate-400)' }}>{user?.email}</span>
          <div className="dash-avatar" style={{ background: 'linear-gradient(135deg,#34D399,#059669)' }}>{initials}</div>
